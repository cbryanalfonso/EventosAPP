...
import {
  RootStackParamList,
  RootStackParamListAuth,
} from '../Hooks/Firebase/exportNavigations';
...
import {CreateNewEvent} from './HomeEvents/CreateNewEvent';
    ...
    <MainStackAuth.Navigator>
      ...
      <MainStackAuth.Screen
        ...
        options={({navigation}) => ({
          ...
          headerLeft: props => <ButtonBack />,
          headerTitle: props => <HeaderTitle texto="Notifications" />,
          headerRight: props => <HeaderLogoLeft />,
